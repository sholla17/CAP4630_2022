...
class Checker(TwoPlayerGame):
    ...
    def possible_moves(self):
        """
        ####I CHANGED THIS METHOD TO RETURN EMPTY ARRAY AFTER LOSING THE GAME TO PASS THE POSSIBLE MOVES UNIT TEST###
        """
        if self.lose():
            return []
    ...
    def make_move(self, pos):
        ...
        [[0,B,0,B,0,B,0,B],
         ...
         [W,0,W,0,W,0,W,0]]
        ------
        you could implement this way but easier to do in one line of code.
    ...
    def lose(self):
        ...
        looks for a string character of W or B in the coordinates in the opposing territory and returns lose = True otherwise returns false so game continues.
        """
        for i, j in self.black_territory:
            if "W" in str(self.board[i,j]):
                return True
        for i, j in self.white_territory:
            if "B" in str(self.board[i,j]):
                return True
        return False
        #pass
